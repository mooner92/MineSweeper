      ...
      <Section title="1. 업로드">
        <Bullets
          items={[
            ...
            <>같은 <strong>지원번호</strong>(예: 2401-000050)를 다시 올리면 이전 추출을 <strong>덮어씁니다</strong> — 항상 1지원자 = 1카드.</>,
      ...
      <Section title="3. 검토 필요 큐">
        <Bullets
          items={[
            ...
            <><strong>구글스칼라(h-지수) 캡처는 “확인 필수” 예외 문서</strong>입니다. 저자 목록이 “…”로 잘리고 공저자 패널이 가려지는 등 캡처 자체에 일부만 담겨, 추출 인물을 <strong>전원 “미확인”</strong>으로 띄웁니다 — 반드시 원본과 대조하세요(자세히는 FAQ 참고).</>,
