 ...
 *   jamoEditDistance('박철수', '박철민') === 3   (영 vs 석 share no 자모 — clearly different people)
 * (Syllable-level distance wrongly scored both as 1, flagging 박철수/박철민 as near-duplicates.)
 */
 ...
 *    OCR/손글씨 confusion. 박철수 vs 박철민 is NOT caught (3 자모 apart): obviously different people.
 *  - abbrev (약어): one name is a whole-음절 *prefix* of the other — e.g. 정민 vs 정민호.
