...
const env = {
  ...
  // 'vlm' = local VLM extracts every doc. Real academic author blocks (e.g. "Jiho Lee a,b,
  // Nara Park a,*") and Korean thesis approval pages need an LLM; the deterministic stub
